package com.sankin.diamond.aliyunUtil;
...
public class OSSUtil {
    ...
    private String bucketName = "diamondword";
    private String filedir = "picture/";
    public String KEY;

    public static OSSClient getOSSClient() {
        String endpoint = "oss-cn-beijing.aliyuncs.com";
         String accessKeyId = "LTAI4GE6v8qMugMfcjxoyBsG";
        String accessKeySecret = "ooZfzRRbFc9cd9dFsb1tiB3HMhS05m";
    ...
    public String uploadFile2Oss(MultipartFile file) throws Exception {
        String originalFilename = file.getOriginalFilename();
        String substring = originalFilename.substring(originalFilename.lastIndexOf(".")).toLowerCase();
        Random random = new Random();
        String name = random.nextInt(10000) + System.currentTimeMillis() + substring;
